...
class WidgetWidgetPreview extends AbstractWidget
{
	...
	protected function buildAuthorizedTree(iTreeBuildContext $tree_build_context, WidgetConnection $connection, array $build_context = []): array
	{
		...
		return $this->createComponentTree('widgetPreviewInfo', [
			...
			'templateScopeNote' => 'This support check only looks at the resolved preview HTML template of the widget root node.',
			...
			'serverPreviewTitle' => 'Server HTML preview',
			'jsonPreviewTitle' => 'Widget subtree JSON',
			'jsonPreviewDescription' => 'Extracted from the same SDUI JSON document available through Open JSON.',
			'openJsonLabel' => 'Open JSON',
