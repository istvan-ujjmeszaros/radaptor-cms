...
class WidgetEmailOutbox extends AbstractWidget
{
	...
	public static function buildStrings(): array
	{
		return [
			...
			'admin.email_outbox.col.job' => self::translate('admin.email_outbox.col.job', 'Job'),
			'admin.email_outbox.col.dead_lettered' => self::translate('admin.email_outbox.col.dead_lettered', 'Dead lettered'),
			'admin.email_outbox.pagination.page' => self::translate('admin.email_outbox.pagination.page', 'Page'),
			'admin.email_outbox.pagination.previous' => self::translate('admin.email_outbox.pagination.previous', 'Previous'),
			'admin.email_outbox.pagination.next' => self::translate('admin.email_outbox.pagination.next', 'Next'),
