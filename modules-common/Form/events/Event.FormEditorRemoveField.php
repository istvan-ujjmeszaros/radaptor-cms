...
final class EventFormEditorRemoveField extends AbstractEvent implements iBrowserEventDocumentable
{
	...
	public function run(): void
	{
		...
		try {
			...
			$result = CmsMutationAuditService::withContext(
				...
				static fn (): array => (new FormCaptureAuthoringService())->removeFieldFromDraft(
					$definition_slug,
					$field_key,
					$field_index,
					$field_uid,
			...
			Kernel::logException($exception, 'Inline capture form field remove failed');
